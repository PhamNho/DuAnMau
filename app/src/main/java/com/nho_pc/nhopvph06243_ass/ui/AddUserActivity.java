...
public class AddUserActivity extends AppCompatActivity {
    ...
    public void addUser(View view) {
        ...
        if (username.isEmpty() || password.isEmpty() || changepassword.isEmpty() || phonenumber.isEmpty() || name.isEmpty() || !password.equals(changepassword)) {
            ...
            if (password.isEmpty())
                edtPasswordInAddUser.setError(getString(R.string.notify_empty_pass_word));
            if (changepassword.isEmpty())
                edtChangePasswordInAddUser.setError(getString(R.string.notify_empty_pass_word));
            if (!password.equals(changepassword))
                edtChangePasswordInAddUser.setError("Mật khẩu không trùng khớp !");
            if (phonenumber.isEmpty())
                edtPhoneNumberInAddUser.setError(getString(R.string.notify_empty_pass_word));
